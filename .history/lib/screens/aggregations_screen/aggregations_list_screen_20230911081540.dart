              ...
              itemBuilder: (context, index) {
                ...
                return Card(
                  child: ListTile(
                    ...
                    title: Text("${aggregation.type}  "),
                    subtitle: Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        Text("${aggregation.total} "),
                        Text("${aggregation.address} "),
                      ],
                      ...
                      itemBuilder: (BuildContext context) {
                        return <PopupMenuEntry<String>>[
                          PopupMenuItem<String>(
                            onTap: () => TransferRepo.instance.updateTransfer(
                                id: 12,
                                amount: 1000,
                          ...
                          PopupMenuItem<String>(
                            onTap: () =>
                                TransferRepo.instance.deleteTransfer(id: 2),
                            value: 'Delete',
